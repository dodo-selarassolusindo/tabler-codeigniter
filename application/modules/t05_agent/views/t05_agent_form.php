                ...
                <div class="card">
                    <form action="<?php echo $action; ?>" method="post" class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label required" for="komisi">Komisi <?php echo form_error('komisi') ?></label>
                                <div><input type="text" class="form-control" name="komisi" id="komisi" placeholder="Komisi" value="<?php echo $komisi; ?>" /></div>
                            </div>
                            <input type="hidden" name="id" value="<?php echo $id; ?>" />
                        </div>
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary"><?= $button ?></button>
                    	    <a href="<?php echo site_url('t05_agent') ?>" class="btn btn-secondary">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
