    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="<?= site_url('t05_agent/create') ?>" class="btn btn-primary d-none d-sm-inline-block">
                        Tambah Data
                    </a>
                ...
                <div class="card">
                        ...
                        <div class="d-flex">
                            <div class="text-muted">
                                ...
                                <div class="ms-2 d-inline-block">
                                    <form action="<?= site_url('t05_agent/index') ?>" method="get">
                                        <div class="input-group">
                                            <input type="text" class="form-control form-control-sm" name="q" value="<?= $q ?>">
                                            <span class="input-group-btn">
                                                <?php if ($q <> '') { ?>
                                                <a href="<?= site_url('t05_agent') ?>" class="btn btn-secondary btn-sm">Reset</a>
                                                <?php } ?>
                    ...
                    <div class="table-responsive">
                        <table class="table card-table table-vcenter text-nowrap datatable">
                            ...
                            <?php foreach ($t05_agent_data as $t05_agent) { ?>
                            <tr>
                                <td width="80px"><?= ++$start ?></td>
                                <td><?= $t05_agent->nama ?></td>
                    ...
                    <div class="card-footer d-flex align-items-center">
                        <p class="m-0 text-muted">Menampilkan <span><?= count($t05_agent_data) ?></span> dari <span><?= $total_rows ?></span> data</p>
                        <?= $pagination ?>
                    </div>
                </div>
            </div>
