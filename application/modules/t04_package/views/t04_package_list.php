...
?>
		...
		<th>Dnfb Harga</th><th>Proses Data</th>
                                    </tr><?php foreach ($t04_package_data as $t04_package) { ?>
                                                    <tr>
			<td width="80px"><?php echo ++$start ?></td>
			<td><?php echo $t04_package->periode ?></td>
			<td><?php echo $t04_package->kode ?></td>
			<td><?php echo $t04_package->nama ?></td>
			<td><?php echo $t04_package->ln3n_mata_uang ?></td>
			<td><?php echo $t04_package->ln3n_harga ?></td>
			<td><?php echo $t04_package->ln6n_mata_uang ?></td>
			<td><?php echo $t04_package->ln6n_harga ?></td>
			<td><?php echo $t04_package->ln1n_mata_uang ?></td>
			<td><?php echo $t04_package->ln1n_harga ?></td>
			<td><?php echo $t04_package->dnrb_mata_uang ?></td>
			<td><?php echo $t04_package->dnrb_harga ?></td>
			<td><?php echo $t04_package->dnfb_mata_uang ?></td>
			<td><?php echo $t04_package->dnfb_harga ?></td>
			<td style="text-align:center" width="200px">
				...
				echo ' | ';
				echo anchor(site_url('t04_package/delete/'.$t04_package->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
				?>
			</td>
		</tr>
                                    <?php } ?>
