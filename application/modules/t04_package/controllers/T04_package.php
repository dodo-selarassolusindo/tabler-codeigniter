...
class T04_package extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 't04_package/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 't04_package/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 't04_package/index.html';
            $config['first_url'] = base_url() . 't04_package/index.html';
        }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2023-08-11 17:02:58 */
/* http://harviacode.com */
