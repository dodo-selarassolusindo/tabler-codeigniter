...
class T33_selisih_price_model extends CI_Model
{

    public $table = 't33_selisih_price';
    public $id = 'id';
    public $order = 'DESC';
...
/* End of file T33_selisih_price_model.php */
/* Location: ./application/models/T33_selisih_price_model.php */
