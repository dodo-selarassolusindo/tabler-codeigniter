                    ...
                    <form action="<?php echo $action; ?>" method="post" class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col"><input type="text" class="form-control" name="package" id="package" placeholder="Package" value="<?php echo $package; ?>" /></div>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-2 col-form-label required" for="night">Night <?php echo form_error('night') ?></label>
                                <div class="col"><input type="text" class="form-control" name="night" id="night" placeholder="Night" value="<?php echo $night; ?>" /></div>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-2 col-form-label required" for="check_in">Check In <?php echo form_error('check_in') ?></label>
                                <div class="col"><input type="text" class="form-control" name="check_in" id="check_in" placeholder="Check In" value="<?php echo $check_in; ?>" /></div>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-2 col-form-label required" for="check_out">Check Out <?php echo form_error('check_out') ?></label>
                                <div class="col"><input type="text" class="form-control" name="check_out" id="check_out" placeholder="Check Out" value="<?php echo $check_out; ?>" /></div>
                            </div>
                            <div class="mb-3 row">
