                        ...
                        <div class="navbar">
                            <div class="container-xl">
                                <ul class="navbar-nav">
                                    ...
                                    <!-- Menu Home -->
                                    <li class="nav-item
                                    <?php if ($this->uri->segment(1) == '') {echo 'active';} ?>
                                    ">
                                    ...
                                    switch($this->uri->segment(1)) {
                                        case 't00_mata_uang':
                                        case 't01_jenis_pembayaran':
                                        case 't02_jenis_selisih_pembayaran':
                                        case 't03_periode':
                                        case 't04_package':
                                        case 't05_agent':
                                        case 't06_country':
                                        ...
                                        <div class="dropdown-menu">
                                            <div class="dropdown-menu-columns">
                                                <div class="dropdown-menu-column">
                                                    ...
                                                    <a class="dropdown-item" href="<?= site_url('t99_catatan') ?>">
                                                        Catatan
                                                    </a>
                                                </div>
                                            </div>
