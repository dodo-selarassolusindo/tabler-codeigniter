                                        ...
                                        <table class="table card-table table-vcenter text-nowrap datatable">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><a href="<?= site_url() ?>invoice.html" class="text-reset" tabindex="-1">Design Works</a></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?= site_url() ?>invoice.html" class="text-reset" tabindex="-1">UX Wireframes</a></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?= site_url() ?>invoice.html" class="text-reset" tabindex="-1">New Dashboard</a></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?= site_url() ?>invoice.html" class="text-reset" tabindex="-1">Landing Page</a></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?= site_url() ?>invoice.html" class="text-reset" tabindex="-1">Marketing Templates</a></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?= site_url() ?>invoice.html" class="text-reset" tabindex="-1">Sales Presentation</a></td>
                                                    <td>
                                                        <span class="flag flag-country-br"></span>
                                                        Tabdaq
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?= site_url() ?>invoice.html" class="text-reset" tabindex="-1">Logo & Print</a></td>
                                                    <td>
                                                        <span class="flag flag-country-us"></span>
                                                        Apple
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?= site_url() ?>invoice.html" class="text-reset" tabindex="-1">Icons</a></td>
                                                    <td>
                                                        <span class="flag flag-country-pl"></span>
                                                        Tookapic
                                                    </td>
